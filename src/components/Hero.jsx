...
function Hero() {
  return (
    <section
      id="hero"
      className="relative flex min-h-[720px] h-screen items-center justify-center overflow-hidden pt-[140px] max-[900px]:pt-[88px] max-[600px]:pt-[82px] max-[380px]:pt-[76px] max-[768px]:min-h-[640px]"
    >
      <div
        className="anim-hero-zoom pointer-events-none absolute inset-0 origin-center bg-cover bg-center"
        style={{
          backgroundImage: `linear-gradient(160deg,rgba(14,56,94,0.85)_0%,rgba(10,26,47,0.78)_55%,rgba(247,198,27,0.15)_100%),url(${heroBgUrl})`,
        }}
      />
      <div className="pointer-events-none absolute inset-0 bg-[length:80px_80px] bg-[linear-gradient(rgba(247,198,27,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(247,198,27,0.04)_1px,transparent_1px)]" />
      <div className="relative z-[2] max-w-[880px] px-6 text-center">
        ...
        <p className="anim-fade-down-delay-6 mx-auto my-5 mb-10 max-w-2xl text-[clamp(12px,1.5vw,15px)] font-normal uppercase tracking-[0.16em] text-silver">
