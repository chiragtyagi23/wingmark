    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-0 font-serif leading-none text-charcoal">
          ...
          <span className="-mt-px whitespace-nowrap text-[22px] font-bold leading-[0.88] tracking-[0.04em] max-[1180px]:text-lg max-[900px]:text-lg max-[600px]:text-base max-[380px]:text-lg">
            Wingsmark Infraa
          </span>
