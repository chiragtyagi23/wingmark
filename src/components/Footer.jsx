...
function Footer() {
  ...
  const colLink =
    'text-[13px] text-med-gray no-underline transition-all duration-300 hover:pl-1 hover:text-gold';

  return (
    <footer className="relative border-t-[3px] border-gold bg-gradient-to-b from-ink to-charcoal px-[5vw] pb-10 pt-20 before:pointer-events-none before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-gold before:to-transparent">
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-10 border-b border-[rgba(97,98,99,0.15)] pb-16 md:grid-cols-2 lg:grid-cols-[1.8fr_1fr_1fr_1.4fr] lg:gap-12">
        <div>
          <Link
            to="/"
            className="mb-0 inline-flex items-center gap-4 no-underline"
          >
            <img
              src="/wingsmark-logo.png"
              alt="The Wingsmark Infraa"
              className="h-[150px] w-auto rounded-lg bg-white/95 p-2 drop-shadow-[0_4px_16px_rgba(247,198,27,0.12)] transition-[filter] duration-300 hover:drop-shadow-[0_4px_20px_rgba(247,198,27,0.3)]"
            />
            <div className="flex flex-col gap-1">
              <span className="font-serif text-[26px] font-semibold leading-tight tracking-[0.04em] text-white">
                <span className="text-[0.55em] font-normal italic opacity-80">The</span> Wingsmark Infraa
              </span>
              <span className="text-[9px] font-medium uppercase tracking-[0.2em] text-gold">
                Land · Infrastructure · Growth
              </span>
            </div>
          </Link>
          <div className="my-4 h-0.5 w-12 bg-gradient-to-r from-gold to-transparent" />
          <p className="mb-4 max-w-[340px] text-sm leading-relaxed text-silver">
          ...
          <div className="text-[11px] uppercase tracking-[0.12em] text-med-gray">
            LLP · Incorporated May 2026
          </div>
        </div>

        <div>
          <h5 className="mb-5 border-b border-[rgba(247,198,27,0.15)] pb-3.5 text-xs font-bold uppercase tracking-[0.2em] text-gold">
            Company
          </h5>
          ...
          <ul className="flex list-none flex-col gap-3.5">
            <li>
              <a
                ...
                className="group flex items-start gap-2.5 text-[12.5px] leading-snug text-silver no-underline transition-colors hover:text-gold"
              >
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex items-start gap-2.5 text-[12px] leading-snug text-silver no-underline transition-colors hover:text-gold"
              >
                <span className="mt-px flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[rgba(247,198,27,0.35)] bg-[rgba(247,198,27,0.08)] text-gold transition-colors group-hover:border-gold group-hover:bg-gold group-hover:text-charcoal">
                  <MapPin size={14} />
                </span>
      ...
      <div className="mx-auto mt-10 flex max-w-[1280px] flex-col items-center gap-3 border-t border-[rgba(97,98,99,0.15)] pt-7 text-center">
        <p className="text-xs text-med-gray">© 2026 The Wingsmark Infraa LLP. All rights reserved.</p>
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-2">
          <a
            href="#"
            className="text-[11px] text-med-gray no-underline transition-colors hover:text-gold"
